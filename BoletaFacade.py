...
Pequeño façade que encapsula la lógica para transformar un Pedido (DTO)
en un documento PDF coherente (detalle, subtotal, IVA y total). Evita que
la ventana principal conozca los pormenores de FPDF.
"""
...
class BoletaFacade:
    """Coordina los cálculos y la creación física de la boleta en PDF."""

    def __init__(self, pedido):
        """Recibe el objeto Pedido (DTO) que contiene los menús agregados."""
        self.pedido = pedido
        self.detalle = ""
        self.subtotal = 0
        self.iva = 0
    ...
    def generar_detalle_boleta(self):
        """Construye el desglose línea por línea usando los datos del pedido."""
        self.detalle = ""
    ...
    def crear_pdf(self):
        """Renderiza todas las secciones de la boleta usando la librería FPDF."""
        pdf = FPDF()
        pdf.add_page()
    ...
    def generar_boleta(self):
        """Método de conveniencia que arma el detalle y produce el PDF final."""
